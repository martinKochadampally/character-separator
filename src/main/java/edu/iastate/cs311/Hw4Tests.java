...
public class Hw4Tests {
    public static void main(String[] args) {
        ...
        String path = "/Users/martin/Documents/1.ISU/Semester4/COM S 311/hw4-sp25-cs311/src/cs3110/hw4/";
        try {
            // CharacterSeparator.visualizeSeparations(path + "resources/all_black.bmp");
            // CharacterSeparator.visualizeSeparations(path + "resources/all_white.bmp");
            CharacterSeparator.visualizeSeparations(path + "resources/am_monologue.bmp");
            //CharacterSeparator.visualizeSeparations(path + "resources/concentric_black_squares.bmp");
            // CharacterSeparator.visualizeSeparations(path + "resources/test.bmp");
        } catch (Exception e) {
            System.out.println("Error: " + e.getMessage());
        }
        long startTime = System.nanoTime();

        Pair<List<Integer>, List<Integer>> separation = CharacterSeparator.findSeparationWeighted(path + "resources/concentric_black_squares.bmp");

        long endTime = System.nanoTime();
        long duration = endTime - startTime;

        System.out.printf("Time taken: %.3f seconds%n", duration / 1_000_000_000.0);
    }
    ...
    public static void testCharacterSeparatorSimpleImage() {
        ...
        try {
            String testImagePath = "/Users/martin/Documents/1.ISU/Semester4/COM S 311/hw4-sp25-cs311/src/cs3110/hw4/resources/test.bmp";
            Pair<List<Integer>, List<Integer>> separations = CharacterSeparator.findSeparationWeighted(testImagePath);
    ...
    public static void testInvalidInputs() {
        ...
        try {
            ...
            Pair<List<Integer>, List<Integer>> result = CharacterSeparator.findSeparationWeighted("nonexistent.bmp");

            System.out.println("- Non-existent file: " + (result == null ? "PASS" : "FAIL"));
